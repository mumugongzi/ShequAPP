...
class ShopsAction extends BaseAction {
	...
	public function toShopHome(){
		...
		$shops["deliveryEndTime"] = str_replace('.5',':30',$shops["deliveryEndTime"]);
		$shops["deliveryEndTime"] = str_replace('.0',':00',$shops["deliveryEndTime"]);
		$shops["deliveryStartTime"] = str_replace('.5',':30',$shops["deliveryStartTime"]);
		$shops["deliveryStartTime"] = str_replace('.0',':00',$shops["deliveryStartTime"]);
