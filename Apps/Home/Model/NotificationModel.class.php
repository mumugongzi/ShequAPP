...
//加载IOS推送类
Vendor('notification.ios.IOSBroadcast');	//广播类
Vendor('notification.ios.IOSCustomizedcast');	//自定义播
Vendor('notification.ios.IOSFilecast');		//文件播
Vendor('notification.ios.IOSGroupcast');	//组播
Vendor('notification.ios.IOSUnicast');		//单播
class NotificationModel extends Model {
	protected $appkey           = '55cee64967e58ed5ee006a84'; 
	protected $appMasterSecret     = 'dkjpqtlbf1jktds2hiwnekijdwqufnkt';
	...
	public function sendAndroidUnicast($title,$text) {
		try {
			$unicast = new \AndroidUnicast();//\Vendor\notification\android
			$unicast->setAppMasterSecret($this->appMasterSecret);
			$unicast->setPredefinedKeyValue("appkey",           $this->appkey);
			$unicast->setPredefinedKeyValue("timestamp",        strval(time()));
			// Set your device tokens here
			$unicast->setPredefinedKeyValue("device_tokens",    "Ar-PAfmYj7FdutlGzN4FGnnURzxWeqVsy6ZxlIbrdHkb"); 
			$unicast->setPredefinedKeyValue("ticker",           'Android Unicast');
