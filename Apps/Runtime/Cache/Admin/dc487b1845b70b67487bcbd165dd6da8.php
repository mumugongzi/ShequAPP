...
<html lang="zh-cn">
   ...
   $(function () {
	   $.formValidator.initConfig({
		...
		$("#userPhotoUpload").uploadify({
	        ...
	        uploader      : '/index.php/Admin/Users/uploadPic',
	        onUploadSuccess : function(file, data, response) {
	        	var json = WST.toJson(data);
	        	if(json.status && json.status==1){
		        	$('#userPhotoPreview').attr('src','/'+json.Filedata.savepath+json.Filedata.savethumbname).show();
   ...
   function edit(){
	   ...
	   Plugins.waitTips({title:'信息提示',content:'正在提交数据，请稍后...'});
		$.post("/index.php/Admin/Users/edit",params,function(data,textStatus){
			var json = WST.toJson(data);
			if(json.status=='1'){
				Plugins.setWaitTipsMsg({content:'操作成功',timeout:1000,callback:function(){
				   location.href='/index.php/Admin/Users/';
				}});
       ...
       <form name="myform" method="post" id="myform">
        ...
        <table class="table table-hover table-striped table-bordered wst-form">
           <tr>
             ...
             <td rowspan='6'>
                 <img id='userPhotoPreview' src='<?php if($object['userPhoto'] =='' ): ?>/Apps/Admin/View/img/staff.png<?php else: ?>/<?php echo ($object['userPhoto']); endif; ?>' width='160' height='160'/><br/>
           ...
           <tr>
             <td colspan='3' style='padding-left:250px;'>
                 ...
                 <button type="button" class="btn btn-primary" onclick='javascript:location.href="/index.php/Admin/Users/"'>返&nbsp;回</button>
             </td>
           </tr>
        </table>
       </form>
