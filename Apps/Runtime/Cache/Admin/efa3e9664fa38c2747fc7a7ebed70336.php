...
<html lang="zh-cn">
   ...
   function query(){
	   ...
	   location.href='/index.php/Admin/GoodsAppraises/index/?goodsName='+goodsName+"&shopName="+shopName+'&areaId1='+areaId1+'&areaId2='+areaId2; 
   }
   function edit(id){
       location.href='/index.php/Admin/GoodsAppraises/toEdit/?id='+id;     
   }
   function del(id){
	   Plugins.confirm({title:'信息提示',content:'您确定要删除该商品评价吗?',okText:'确定',cancelText:'取消',okFun:function(){
		   Plugins.closeWindow();
		   Plugins.waitTips({title:'信息提示',content:'正在操作，请稍后...'});
		   $.post("/index.php/Admin/GoodsAppraises/del",{id:id},function(data,textStatus){
        ...
        <table class="table table-hover table-striped table-bordered wst-list">
           ...
           <tbody>
            <?php if(is_array($Page['root'])): $i = 0; $__LIST__ = $Page['root'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
               ...
               <td>
               <div>
               	<?php $__FOR_START_1492520315__=0;$__FOR_END_1492520315__=$vo['goodsScore'];for($i=$__FOR_START_1492520315__;$i < $__FOR_END_1492520315__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>&nbsp;<?php echo ($vo['goodsScore']); ?> 分
				</div>
				</td>
				<td>
				<div>
               	<?php $__FOR_START_108312234__=0;$__FOR_END_108312234__=$vo['timeScore'];for($i=$__FOR_START_108312234__;$i < $__FOR_END_108312234__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>&nbsp;<?php echo ($vo['timeScore']); ?> 分
				</div>
                </td>
                <td>
              	<div>
               	<?php $__FOR_START_726410033__=0;$__FOR_END_726410033__=$vo['serviceScore'];for($i=$__FOR_START_726410033__;$i < $__FOR_END_726410033__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>&nbsp;<?php echo ($vo['serviceScore']); ?> 分
				</div>
               </td>
               <td rowspan='2'>
               <button type="button" class="btn btn-default glyphicon glyphicon-pencil" onclick="javascript:edit(<?php echo ($vo['id']); ?>)"">修改</button>&nbsp;
