        ...
        <table class="table table-hover table-striped table-bordered wst-form">
           <tr>
             ...
             <span style='margin-left:100px;'>
                                       状态：<?php if($object["orderStatus"] == -3): ?>会员拒收
               <elseif condition='$object["orderStatus"] eq -4'>店铺确认拒收
			   <?php elseif($object["orderStatus"] == -2): ?>未付款
			   <?php elseif($object["orderStatus"] == -1): ?>已取消
			   ...
			   <?php elseif($object["orderStatus"] == 4): ?>已到货
			   <?php elseif($object["orderStatus"] == 5): ?>店铺确认到货<?php endif; ?>
             </span></td>
           </tr>
           <tr>
           ...
           <tr>
             ...
             <table width='700'>
                <tr>
                  ...
                  <td>
                  <?php if($object["payType"] == 1): ?>在线支付<?php else: ?>货到付款<?php endif; ?>
                  </td>
                </tr>
                <tr>
                  <td style='text-align:right'>配送方式：</td>
                  <td>
                  <?php if($object["isSelf"] == 1): ?>自提<?php endif; ?>                                                
                  <?php if(($object["isSelf"] == 0) AND ($object["deliverType"] == 1)): ?>店铺配送<?php else: ?>商城配送<?php endif; ?>
           ...
           <tr>
              <td style='text-align:right;padding-right:10px;'>商品总金额：￥<?php echo ($object['totalMoney']); ?><br/>+ 运费：￥<?php echo ($object['deliverMoney']); ?><br/><span style='font-weight:bold;font-size:20px'>订单金额：</span><span style='font-weight:bold;font-size:20px;color:red;'>￥<?php echo ($object['totalMoney']+$object['deliverMoney']); ?></span></td>
           </tr>
           <tr>
