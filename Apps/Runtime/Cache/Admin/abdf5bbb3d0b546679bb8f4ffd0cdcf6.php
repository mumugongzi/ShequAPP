...
<html lang="zh-cn">
   ...
   function edit(){
	   ...
	   $.post("/index.php/Admin/Communitys/edit",params,function(data,textStatus){
			var json = WST.toJson(data);
			if(json.status=='1'){
				Plugins.setWaitTipsMsg({content:'操作成功',timeout:1000,callback:function(){
				   location.href='/index.php/Admin/Communitys/';
				}});
			}else{
				Plugins.closeWindow();
        ...
        <table class="table table-hover table-striped table-bordered wst-form">
           ...
           <tr>
             <td colspan='2' style='padding-left:250px;'>
                 ...
                 <button type="button" class="btn btn-primary" onclick='javascript:location.href="/index.php/Admin/Communitys/"'>返&nbsp;回</button>
             </td>
           </tr>
        </table>
       </form>
