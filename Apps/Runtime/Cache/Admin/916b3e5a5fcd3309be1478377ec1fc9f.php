        ...
        <script>
	      ...
	      function cleanCache(){
	    	  $.post("<?php echo U('Admin/Index/cleanAllCache');?>",{},function(data,textStatus){
	    		  var json = WST.toJson(data);
	  			    if(json.status==1)Plugins.Tips({title:'信息提示',content:'缓存清除成功!',timeout:1000});
	    	  });
	      }
	    </script>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                    <img src="/<?php echo session('WST_STAFF.staffPhoto');?>" class="img-circle" alt="<?php echo session('WST_STAFF.roleName');?>" />
                                        ...
                                        </br></br><?php echo session('WST_STAFF.staffName');?> - <?php echo session('WST_STAFF.roleName');?></br>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content" style='margin:0px;padding:0px;'>
                    <iframe id='pageContent' name='pageContent' src="/index.php/Admin/Index/toMain" width='100%' height='100%' frameborder="0"></iframe>
                </section><!-- /.content -->
            </aside><!-- /.right-side -->
        </div><!-- ./wrapper -->
    </body>
