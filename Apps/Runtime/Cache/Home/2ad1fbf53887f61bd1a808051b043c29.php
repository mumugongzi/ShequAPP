...
<html lang="zh-cn">
	<head>
      	...
      	<title>商铺登录 - <?php echo ($CONF['shopTitle']['fieldValue']); ?></title>
      	<meta name="keywords" content="<?php echo ($CONF['shopKeywords']['fieldValue']); ?>" />
      	<meta name="description" content="<?php echo ($CONF['shopTitle']['fieldValue']); ?>,卖家登录" />
...
<div id="wst-shortcut">
   		...
   		<div style="margin: 0 auto;width: 890px;">
		    ...
		    <div class=" w1" id="entry">       
		        <div class="mc " id="bgDiv" style="position:relative">
		        	<div style="font-size:65px;color:red;position:absolute;top:160px;left:60px;">商铺登录</div>
		            <div class="form">
    ...
    <script src="/Apps/Home/View/default/js/common.js"></script>
   	<script src="/Apps/Home/View/default/js/shop_login.js"></script>
