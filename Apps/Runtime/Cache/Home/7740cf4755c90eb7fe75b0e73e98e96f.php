    ...
    <div class="wst-body"> 
       ...
       <div class='wst-page-content'>
        ...
        <table class='wst-list' style="font-size:13px;">
           ...
           <tbody>
            <?php if(is_array($payOrders['root'])): $key1 = 0; $__LIST__ = $payOrders['root'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order): $mod = ($key1 % 2 );++$key1;?><tr>
                ...
                <td width='*'>
               	...
               	<td width='140'><div style="line-height:20px;"><?php echo ($order["createTime"]); ?></div></td>
               	<td width='60'>
               	...
               	<td width='130' style="line-height:20px;">
               		<a href="javascript:;" onclick="toPay(<?php echo ($order['orderId']); ?>)">支付</a> |
					<a href="javascript:;" onclick="showOrder(<?php echo ($order['orderId']); ?>)">查看</a> | 
					<a href="javascript:;" onclick="orderCancel(<?php echo ($order['orderId']); ?>)">取消订单</a>
				</td>
